...
def generate_launch_description():
    ...
    ####### DATA INPUT ##########
    urdf_file = 'cyber_shopper.urdf'
    xacro_file = "cyber_shopper.urdf.xacro"
    package_description = "cyber_shopper"
    use_urdf = False
    ...
    default_rviz_config_path = PathJoinSubstitution(
        [FindPackageShare("cyber_shopper"), "rviz", "display_default.rviz"]
    )
